...
use DateTime;
use DateTimeZone;
use Fluency\Http\Request\File as RequestFile;
use Fluency\Lang\Translator as Translator;
...
class Validator
{
	 ...
	 * @return void
	 */
	public function __construct($translator, array $data, array $rules, array $messages = array(), array $customAttributes = array())
	{
	...
	protected function validateRequired($attribute, $value)
	{
		...
		{
			return (string) $value->getTempName() != '';
		}
	...
	protected function validateMax($attribute, $value, $parameters)
	{
		...
		if ($value instanceof RequestFile && !$value->isUploadedFile()) return false;
