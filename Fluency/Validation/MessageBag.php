...
class MessageBag implements Countable
{
     ...
     * @return \Engine\Services\Validation\MessageBag
     */
     ...
     *
     * @param  \Engine\Services\Validation\MessageProviderInterface|array  $messages
     *
     * @return \Engine\Services\Validation\MessageBag
     */
    public function merge($messages)
    {
        if (method_exists($messages, 'getMessageBag'))
        {
